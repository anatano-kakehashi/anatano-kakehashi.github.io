...
export const ContentFormatted= tw.div`max-w-screen-xl mx-auto`;
...
export const MainParagraph2 = tw.p`font-roboto font-light text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl`;
