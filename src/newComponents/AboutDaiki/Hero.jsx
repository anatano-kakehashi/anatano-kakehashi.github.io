...
import { aboutDaiki_IntroHero } from "assets/ak-data/AK_Info.jsx";
import profile from "assets/ak-images/aboutMe/daikiJourneyPhotos/prof.jpg";
...
const Row = tw.div`flex flex-col md:flex-row justify-between items-center px-3 lg:px-0`;
...
var currInfo = aboutDaiki_IntroHero[0];
var currNavPath = "/jp/";
export default function IntroAbout(props) {
  if(props.language === "ENG"){
    currInfo = aboutDaiki_IntroHero[1];
    currNavPath = "/";
  }
