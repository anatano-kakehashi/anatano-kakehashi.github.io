...
import aITC from "assets/ak-images/aboutMe/daikiJourneyPhotos/aITC.jpeg";
import ctc from "assets/ak-images/aboutMe/daikiJourneyPhotos/CTC.jpeg";
import iij from "assets/ak-images/aboutMe/daikiJourneyPhotos/IIJ.jpeg";
import uci from "assets/ak-images/aboutMe/daikiJourneyPhotos/UCI.png";
import profile from "assets/ak-images/aboutMe/daikiJourneyPhotos/Daiki.png";

/* ======== importing some data for text =========== */
import { daiki_aboutMe_JourneyHero } from "assets/ak-data/AK_Info.jsx";
...
var currInfo = daiki_aboutMe_JourneyHero[0];
var photos = [uci, aITC, iij, ctc];
export default function JourneyAbout(props) {
  if(props.language === "ENG"){
    currInfo = daiki_aboutMe_JourneyHero[1];
  }
