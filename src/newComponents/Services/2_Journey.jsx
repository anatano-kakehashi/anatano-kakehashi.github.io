...
const Container = tw.div`relative bg-main-white`;
const MainContainer = tw(PaddingContainer)``;
...
const CardParagraph = tw(MainParagraphTemplate)`font-roboto font-light text-main-black text-left pb-4 lg:pb-6`;

// skills container
const SkillsWapper = tw.div`flex flex-col sm:flex-row gap-y-2 md:gap-y-0 gap-x-4 md:gap-x-6 pt-4 md:pt-6`;
const SkillCard = tw.div`sm:basis-1/3 bg-main-lightestBlue px-4 rounded-3xl flex items-center justify-center py-2 lg:py-8`;
const SkillCardParagraph = tw(CardParagraph)`text-center self-center`;
