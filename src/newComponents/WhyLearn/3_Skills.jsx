...
const Container = tw(BaseContainer)`flex flex-col justify-center bg-main-backgroundBlue`;

const MainHeading = tw(MainHeadingTemplate)`text-main-white relative text-center pb-6`;

const Row = tw.div`flex flex-col lg:flex-row justify-between items-center py-4 md:py-8 xl:py-12`;

// Image and text columns for the row
const TextTemplate = tw.div`p-6 lg:p-10 mx-6 lg:mx-0`;
...
`;
const MobileImageContainer = tw.div`relative z-10 lg:hidden`;
...
const MobileImage4 = styled.div`
  ...
  ${tw`bg-cover bg-center object-center m-auto w-[325px] h-[250px] md:w-[550px] md:h-[400px] rounded-t-3xl lg:rounded-none`}
`;
const Offsetbackground4 = tw(Image4SizingTemplate)`absolute inset-0 lg:mr-6 lg:mt-6 xl:mr-8 xl:mt-8 bg-main-yellow hidden lg:inline`;
...
export default function ReasoningsHero(props) {
  ...
  return (
    <Container>
      <ContentWithPaddingXl tw="py-12 lg:py-20">
