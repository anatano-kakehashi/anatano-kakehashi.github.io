...
import { aboutUs_OurGoalHero } from "assets/ak-data/AK_Info.jsx";

const Container = tw(BaseContainer)`bg-main-white lg:px-0`;
...
var currInfo = aboutUs_OurGoalHero[0];
export default function MyGoalHero(props) {
  if(props.language === "ENG"){
    currInfo = aboutUs_OurGoalHero[1];
  }
